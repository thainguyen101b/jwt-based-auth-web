...
class DataSourceConfiguration {
    ...
    void setQueryLogMessageFormat() {
        P6SpyOptions.getActiveInstance().setLogMessageFormat(PrettyQueryLogStrategy.class.getName());
    }

    public static class PrettyQueryLogStrategy implements MessageFormattingStrategy {
        @Override
        ...
        private String summary(String prettyQuery, int connectionId, long elapsed, String stacktrace) {
            return """
                ...
                %s
                ----------------------------------------------------------------------------------------------------
                """.formatted(prettyQuery, connectionId, elapsed, stacktrace);
        }
        ...
        private String stacktrace() {
            ...
            Arrays.stream(new Throwable().getStackTrace())
                    ...
                    .filter(trace -> trace.startsWith("io.nguyen.jwtbasedauthserver"))
