...
class UserServiceTest {
    ...
    void updateUserDetailsSuccessScenario() {
        ...
        when(userRepository.updateUserDetails(any(), any(), any(), any(), any(), any()))
                .thenReturn(initialUser);

        // when
        User result = sut.updateUser(testUuid, testEmail, testUsername, testPassword, testImageUrl);
    ...
    void updateUserDetailsWithNullID() {
        ...
        assertThrows(
                ...
                () -> sut.updateUser(
                        null, "testEmail", "testUsername", "testPassword", "testImageUrl"));
    }
}